public class V_Cooldown {
    ...
    public int func(int ind, int buy, int[] prices){
        ...
        if(buy==0){
            ...
            profit = Math.max(prices[ind]+func(ind+2, 0, prices), 0+func(ind+1, buy, prices));
        }
        return profit;
    }
    ...
    public int funcMemo(int ind, int buy, int[] prices, int[][] dp){
        ...
        if(buy==0){
            ...
            profit = Math.max(prices[ind]+funcMemo(ind+2, 0, prices,dp), 0+funcMemo(ind+1, buy, prices,dp));
        }
        dp[ind][buy] = profit;
        return dp[ind][buy];
    }
        ...
        for (int ind = n-1; ind >= 0; ind--) {
            for (int buy = 0; buy <= 1; buy++) {
                ...
                if(buy==0){
                    ...
                    profit = Math.max(prices[ind]+dp[ind+2][0], 0+dp[ind+1][buy]);
                }
                dp[ind][buy] = profit;
            }
        }
    ...
    //             }
    //             else{
    //                 profit = Math.max(prices[ind]+dp2[0], 0+dp[1]);
    //             }
    //             cur[buy] = profit;
    //         }
    //         dp2 = dp;
